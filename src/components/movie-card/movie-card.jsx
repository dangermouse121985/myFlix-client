...
export const MovieCard = ({ movie }) => {
  ...
  const delFav = () => {
    {
      fetch(
        /* `https://dcrichlow-mymoviesflix-bb84bd41ee5a.herokuapp.com/users/${user.username}/favorites/${movie.id}` */ `http://MyCFLoadBalancer-2097481282.us-east-1.elb.amazonaws.com/users/${user.username}/favorites/${movie.id}`,
        {
